...
const PORTFOLIO_DESCRIPTION = `Dokumentasi ${projectCount} proyek furniture custom SAVOY: kitchen set, lemari pakaian, sampai interior rumah penuh di apartemen, perumahan, dan rumah subsidi.`;
