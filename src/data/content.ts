...
export const problems: ProblemCard[] = [
  {
    ...
    image: "/images/problems/masalah-01.webp",
  },
  {
    index: "Masalah 02",
    ...
    image: "/images/problems/masalah-02.webp",
  },
  {
    index: "Masalah 03",
    ...
    image: "/images/problems/masalah-03.webp",
  },
  {
    index: "Masalah 04",
    ...
    image: "/images/problems/masalah-04.webp",
  },
];

/* ------------------------------------------------------------------ */
/* Section 03 - the SAVOY approach                                   */
/* ------------------------------------------------------------------ */
...
export const processSteps: ProcessStep[] = [
  ...
  },
  {
    index: "05",
    title: "Produksi",
    body: "Fabrikasi di workshop SAVOY dengan mesin potong presisi dan pelapisan rapi oleh pengrajin berpengalaman.",
  },
  {
    index: "06",
...
export const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Ya, seluruh pengerjaan SAVOY bersifat custom made-to-measure. Termasuk mengatasi dinding miring, kolom struktur yang menonjol, ruang bawah tangga yang menyudut, atau langit-langit atap miring (attic).",
  },
  {
    id: "material-dapur",
